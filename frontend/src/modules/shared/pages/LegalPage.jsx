...
const legalContent = {
  terms: {
    ...
    icon: ScrollText,
    intro:
      'These terms are shown from the latest legal document provided for Ninja Truck users and include the applicable bike, package, auto, and cab clauses.',
  ...
  privacy: {
    ...
    icon: ShieldCheck,
    intro:
      'This privacy policy is shown from the latest legal document provided for Ninja Truck users and explains how information is collected, used, processed, stored, and protected.',
  ...
  refund: {
    ...
    icon: ReceiptText,
    intro:
      'This page explains refund eligibility, cancellation timelines, and indicative prices for the main vehicle types available on the Ninja Truck  Trawler platform. Refunds are reviewed based on service status, time of cancellation, and payment mode.',
    sections: [
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          'Ninja Truck   Trawler may ask for screenshots, transaction references, or additional verification before approval.',
        ],
      },
      {
  ...
  cancellation: {
    ...
    icon: Scale,
    intro:
      'This page summarizes how cancellations are handled across Ninja Truck  Trawler booking categories.',
    sections: [
      {
